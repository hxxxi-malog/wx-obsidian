...
**从原文中提取图片 URL，在笔记的关键位置插入。**

### 图片插入规则
1. **架构图/流程图**：在描述架构或流程的文字后面插入，帮助读者建立视觉认知
2. **概念关系图**：在厘清多个概念关系后插入，强化理解
3. **关键截图/示意图**：在拆解具体机制时插入，让抽象描述具象化
...
**写作要求**：
- 图片描述要简洁但信息完整，说明图片展示的是什么
- 图片前后要有文字说明，不要让图片"孤立"出现
- 优先插入架构全景图、核心机制图、概念关系图，跳过装饰性图片
